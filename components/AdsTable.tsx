...
const getCellStyle = (key: string, value: any, isFirstColumn: boolean) => {
  ...
  if (isFirstColumn) {
    return 'font-bold text-slate-900 bg-white sticky left-0 z-20 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] text-left';
  }
        ...
        >
            ...
            <table className="w-full text-left border-collapse select-none md:select-auto">
                ...
                <tr>
                    ...
                    <th className="px-4 py-3 md:px-6 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-200 whitespace-nowrap sticky left-0 z-40 bg-slate-50 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] pl-5 text-left">
                    {accountKey}
                    </th>
                    ...
                    {/* 3. Campaign Header */}
                    {campaignNameKey && (
                    <th className="px-4 py-3 md:px-6 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-200 whitespace-nowrap text-center">
                        {campaignNameKey}
                    </th>
                    )}
                    ...
                    {/* 4. Rest of Headers */}
                    {restKeys.map((key) => (
                    <th key={key} className="px-4 py-3 md:px-6 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-200 whitespace-nowrap text-center">
                        {key}
                    </th>
                    ))}
                </tr>
